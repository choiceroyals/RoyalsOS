...
import {
  registerRoyalOSDeveloperProposal,
...
export async function POST(
  ...
  try {
    ...
    const approvalEnvelope =
      await registerRoyalOSDeveloperProposal(
        proposal
      );
    ...
    return Response.json(
      {
        ...
        approval: {
          ...
          approvalId:
            approvalEnvelope.approvalId,

          approvalToken:
            approvalEnvelope.approvalToken,

          expiresAt:
            approvalEnvelope.expiresAt,
