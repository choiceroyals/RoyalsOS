      ...
      >
        ...
        >
          <div>
            ...
            >
              Orion reads only the files you approve and
              prepares complete replacement code for your
              review. He still cannot edit, apply, delete,
      ...
      {!loading && proposal ? (
        <>
          ...
          >
            ...
            >
              This proposal has not been approved or applied.
              The next development stage will create a permanent
              CEO approval record, code differences, protected
              backups, controlled application, validation, and
              automatic rollback.
            </p>
          </section>
        </>
